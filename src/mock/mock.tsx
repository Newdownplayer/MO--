    ...
    if (group_by === 'happen_at' && kind === 'expenses') {
        ...
        return [200, {
            groups: [
                ...
                { happen_at: '2023-02-12T00:00:00.000+0800', amount: 300 },
                { happen_at: '2023-02-19T00:00:00.000+0800', amount: 200 }],
            summary: 600
        }]
...
export const mockItemCreate: Mock = config => {
    return [200, {
        resource: {
            ...
            "note": null,
            "tags_id": [3508],
            "happen_at": "2022-10-29T16:00:00.000Z",
            "created_at": "2023-02-03T15:35:56.301Z",
            "updated_at": "2023-02-03T15:35:56.301Z",
            "kind": "expenses"
        }
    }]
}
